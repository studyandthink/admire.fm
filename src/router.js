...
import category from './componends/navbar/admireFM/category.vue' //节目分类页面
import categoryChange from './componends/navbar/admireFM/categoryList.vue'
import communicationPart from './componends/navbar/admireFM/communicationPart.vue' //交流社区页面
import communicationDetails from './componends/navbar/admireFM/communicationDetails.vue' //交流社区页面
import communicationCompile from './componends/navbar/admireFM/communicationCompile.vue' //交流社区发布页面

import comment from './componends/navbar/admireFM/playerPageComment.vue'

import search from './componends/navbar/admireFM/search.vue'
